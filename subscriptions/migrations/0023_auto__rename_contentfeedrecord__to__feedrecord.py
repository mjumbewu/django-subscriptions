...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'ContentFeedRecord' to 'FeedRecord'
        db.rename_table(u'subscriptions_contentfeedrecord', u'subscriptions_feedrecord')
        db.send_create_signal(u'subscriptions', ['FeedRecord'])

    def backwards(self, orm):
        # Renaming model 'FeedRecord' to 'ContentFeedRecord'
        db.rename_table(u'subscriptions_feedrecord', u'subscriptions_contentfeedrecord')
